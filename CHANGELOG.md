...
## [2.4.1](https://github.com/ron86i/go-siat/compare/v2.4.0...v2.4.1) (2026-09-14)

### Maintenance

* **facturacion:** documenta la API pública `WithFacturasEnLote` y mantiene compatibilidad con la serie 2.4.x.
