...
func TestComercializacionGnGlp_Electronica(t *testing.T) {
	...
	cabecera := facturas.NewComercializacionGnGlpCabeceraBuilder().
	...
	detalle := facturas.NewComercializacionGnGlpDetalleBuilder().
	...
	factura := facturas.NewComercializacionGnGlpBuilder().
