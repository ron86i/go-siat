...
func TestComercialExportacionPVenta_Electronica(t *testing.T) {
	...
	cabecera := facturas.NewComercialExportacionPVentaCabeceraBuilder().
	...
	detalle := facturas.NewComercialExportacionPVentaDetalleBuilder().
	...
	factura := facturas.NewComercialExportacionPVentaBuilder().
