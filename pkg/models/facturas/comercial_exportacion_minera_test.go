...
func TestComercialExportacionMinera_Electronica(t *testing.T) {
	...
	cabecera := facturas.NewComercialExportacionMineraCabeceraBuilder().
	...
	detalle := facturas.NewComercialExportacionMineraDetalleBuilder().
	...
	factura := facturas.NewComercialExportacionMineraBuilder().
