...
func TestVentaCombustibleSinSubvencion_Electronica(t *testing.T) {
	...
	cabecera := facturas.NewVentaCombustibleSinSubvencionCabeceraBuilder().
	...
	detalle := facturas.NewVentaCombustibleSinSubvencionDetalleBuilder().
	...
	factura := facturas.NewVentaCombustibleSinSubvencionBuilder().
