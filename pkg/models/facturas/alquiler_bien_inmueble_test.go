...
func TestAlquilerBienInmueble_Electronica(t *testing.T) {
	...
	cabecera := facturas.NewAlquilerBienInmuebleCabeceraBuilder().
	...
	detalle := facturas.NewAlquilerBienInmuebleDetalleBuilder().
	...
	factura := facturas.NewAlquilerBienInmuebleBuilder().
