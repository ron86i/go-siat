...
func TestComercialExportacionHidro_Electronica(t *testing.T) {
	...
	cabecera := facturas.NewComercialExportacionHidroCabeceraBuilder().
	...
	detalle := facturas.NewComercialExportacionHidroDetalleBuilder().
	...
	factura := facturas.NewComercialExportacionHidroBuilder().
