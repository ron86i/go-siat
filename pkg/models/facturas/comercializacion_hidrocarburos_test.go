...
func TestComercializacionHidrocarburos_Electronica(t *testing.T) {
	...
	codigoPais := 1
	cabecera := facturas.NewComercializacionHidroCabeceraBuilder().
	...
	detalle := facturas.NewComercializacionHidroDetalleBuilder().
	...
	factura := facturas.NewComercializacionHidroBuilder().
