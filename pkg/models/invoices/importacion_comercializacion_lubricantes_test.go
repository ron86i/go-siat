...
func TestImportacionLubricantes_Electronica(t *testing.T) {
	...
	cabecera := invoices.NewImportacionComercializacionLubricantesCabeceraBuilder().
	...
	detalle := invoices.NewImportacionComercializacionLubricantesDetalleBuilder().
	...
	factura := invoices.NewImportacionComercializacionLubricantesBuilder().
