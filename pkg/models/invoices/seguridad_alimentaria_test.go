...
func TestSeguridadAlimentaria_Electronica(t *testing.T) {
	...
	cabecera := invoices.NewSeguridadAlimentariaCabeceraBuilder().
	...
	detalle := invoices.NewSeguridadAlimentariaDetalleBuilder().
	...
	factura := invoices.NewSeguridadAlimentariaBuilder().
