...
func TestHospitalClinicaZonaFranca_Electronica(t *testing.T) {
	...
	cabecera := invoices.NewHospitalClinicaZFCabeceraBuilder().
	...
	detalle1 := invoices.NewHospitalClinicaZonaFrancaDetalleBuilder().
	...
	factura := invoices.NewHospitalClinicaZFBuilder().
