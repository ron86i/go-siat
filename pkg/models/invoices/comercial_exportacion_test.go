...
func TestComercialExportacion_Computarizada(t *testing.T) {
	...
	cabecera := invoices.NewComercialExportacionCabeceraBuilder().
	...
	detalle := invoices.NewComercialExportacionDetalleBuilder().
	...
	factura := invoices.NewComercialExportacionBuilder().
