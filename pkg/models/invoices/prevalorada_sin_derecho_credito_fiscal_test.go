...
func TestPrevaloradaSinDerechoCreditoFiscal_Computarizada(t *testing.T) {
	...
	cabecera := invoices.NewPrevaloradaSinDerechoCreditoFiscalCabeceraBuilder().
	...
	detalle := invoices.NewPrevaloradaSinDerechoCreditoFiscalDetalleBuilder().
	...
	factura := invoices.NewPrevaloradaSinDerechoCreditoFiscalBuilder().
