...
> Complete reference for all 7 SIAT services exposed by the `go-siat` SDK. Each method includes its signature, builder, and response navigation.
...
9. [Response Verification](#response-verification)
