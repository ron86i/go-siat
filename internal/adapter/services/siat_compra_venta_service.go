...
// SiatCompraVentaService implementa el puerto ports.SiatCompraVentaService para interactuar
...
// RecepcionAnexos
func (s *SiatCompraVentaService) RecepcionAnexos(ctx context.Context, config ports.Config, opaqueReq models.RecepcionAnexosCompraVenta) (*soap.EnvelopeResponse[compra_venta.RecepcionAnexosResponse], error) {
	return performSoapRequest[compra_venta.RecepcionAnexos, compra_venta.RecepcionAnexosResponse](ctx, s.httpClient, s.url, config, opaqueReq)
}

// ValidacionRecepcionMasivaFactura
func (s *SiatCompraVentaService) ValidacionRecepcionMasivaFactura(ctx context.Context, config ports.Config, opaqueReq models.ValidacionRecepcionMasivaFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionMasivaFacturaResponse], error) {
...
func (s *SiatCompraVentaService) VerificacionEstadoFactura(ctx context.Context, config ports.Config, opaqueReq models.VerificacionEstadoFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.VerificacionEstadoFacturaResponse], error) {
...
func (s *SiatCompraVentaService) RecepcionMasivaFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionMasivaFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.RecepcionMasivaFacturaResponse], error) {
...
func (s *SiatCompraVentaService) VerificarComunicacion(ctx context.Context, config ports.Config, opaqueReq models.VerificarComunicacionCompraVenta) (*soap.EnvelopeResponse[facturacion.VerificarComunicacionResponse], error) {
...
// ValidacionRecepcionPaqueteFactura permite validar la recepción de paquetes de invoices.
// Recibe una solicitud opaca de tipo ValidacionRecepcionPaqueteFacturaRequest construida vía Builder.
func (s *SiatCompraVentaService) ValidacionRecepcionPaqueteFactura(ctx context.Context, config ports.Config, opaqueReq models.ValidacionRecepcionPaqueteFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionPaqueteFacturaResponse], error) {
...
func (s *SiatCompraVentaService) RecepcionPaqueteFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionPaqueteFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.RecepcionPaqueteFacturaResponse], error) {
...
func (s *SiatCompraVentaService) ReversionAnulacionFactura(ctx context.Context, config ports.Config, opaqueReq models.ReversionAnulacionFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.ReversionAnulacionFacturaResponse], error) {
...
func (s *SiatCompraVentaService) AnulacionFactura(ctx context.Context, config ports.Config, opaqueReq models.AnulacionFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.AnulacionFacturaResponse], error) {
...
func (s *SiatCompraVentaService) RecepcionFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionFactura) (*soap.EnvelopeResponse[facturacion.RecepcionFacturaResponse], error) {
...
var _ ports.SiatCompraVentaService = (*SiatCompraVentaService)(nil)
