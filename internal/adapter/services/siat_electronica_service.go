...
func (s *SiatElectronicaService) AnulacionFactura(ctx context.Context, config ports.Config, opaqueReq models.AnulacionFacturaElectronica) (*soap.EnvelopeResponse[facturacion.AnulacionFacturaResponse], error) {
...
func (s *SiatElectronicaService) RecepcionFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionFacturaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionFacturaResponse], error) {
...
func (s *SiatElectronicaService) ReversionAnulacionFactura(ctx context.Context, config ports.Config, opaqueReq models.ReversionAnulacionFacturaElectronica) (*soap.EnvelopeResponse[facturacion.ReversionAnulacionFacturaResponse], error) {
...
func (s *SiatElectronicaService) RecepcionPaqueteFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionPaqueteFacturaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionPaqueteFacturaResponse], error) {
...
// ValidacionRecepcionPaqueteFactura envía una solicitud al SIAT para validar la recepción de un paquete de invoices.
func (s *SiatElectronicaService) ValidacionRecepcionPaqueteFactura(ctx context.Context, config ports.Config, opaqueReq models.ValidacionRecepcionPaqueteFacturaElectronica) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionPaqueteFacturaResponse], error) {
...
func (s *SiatElectronicaService) VerificarComunicacion(ctx context.Context, config ports.Config, opaqueReq models.VerificarComunicacionElectronica) (*soap.EnvelopeResponse[facturacion.VerificarComunicacionResponse], error) {
...
func (s *SiatElectronicaService) RecepcionMasivaFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionMasivaFacturaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionMasivaFacturaResponse], error) {
...
// ValidacionRecepcionMasivaFactura envía una solicitud al SIAT para validar la recepción masiva de invoices.
func (s *SiatElectronicaService) ValidacionRecepcionMasivaFactura(ctx context.Context, config ports.Config, opaqueReq models.ValidacionRecepcionMasivaFacturaElectronica) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionMasivaFacturaResponse], error) {
...
func (s *SiatElectronicaService) VerificacionEstadoFactura(ctx context.Context, config ports.Config, opaqueReq models.VerificacionEstadoFacturaElectronica) (*soap.EnvelopeResponse[facturacion.VerificacionEstadoFacturaResponse], error) {
...
func (s *SiatElectronicaService) RecepcionAnexosSuministroEnergia(ctx context.Context, config ports.Config, opaqueReq models.RecepcionAnexosSuministroEnergiaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionAnexosSuministroEnergiaResponse], error) {
...
var _ ports.SiatElectronicaService = (*SiatElectronicaService)(nil)
