...
// SiatCodigosService implementa el puerto ports.SiatCodigosService para interactuar con el SIAT.
...
func (s *SiatCodigosService) VerificarComunicacion(ctx context.Context, config ports.Config, opaqueReq models.VerificarComunicacionCodigos) (*soap.EnvelopeResponse[codigos.VerificarComunicacionResponse], error) {
...
func (s *SiatCodigosService) NotificaCertificadoRevocado(ctx context.Context, config ports.Config, opaqueReq models.NotificaCertificadoRevocado) (*soap.EnvelopeResponse[codigos.NotificaCertificadoRevocadoResponse], error) {
...
func (s *SiatCodigosService) SolicitudCufd(ctx context.Context, config ports.Config, opaqueReq models.Cufd) (*soap.EnvelopeResponse[codigos.CufdResponse], error) {
...
func (s *SiatCodigosService) SolicitudCufdMasivo(ctx context.Context, config ports.Config, opaqueReq models.CufdMasivo) (*soap.EnvelopeResponse[codigos.CufdMasivoResponse], error) {
...
func (s *SiatCodigosService) SolicitudCuis(ctx context.Context, config ports.Config, opaqueReq models.Cuis) (*soap.EnvelopeResponse[codigos.CuisResponse], error) {
...
func (s *SiatCodigosService) SolicitudCuisMasivo(ctx context.Context, config ports.Config, opaqueReq models.CuisMasivo) (*soap.EnvelopeResponse[codigos.CuisMasivoResponse], error) {
...
func (s *SiatCodigosService) VerificarNit(ctx context.Context, config ports.Config, opaqueReq models.VerificarNit) (*soap.EnvelopeResponse[codigos.VerificarNitResponse], error) {
