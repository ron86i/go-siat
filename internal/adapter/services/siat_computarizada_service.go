...
func (s *siatComputarizadaService) RecepcionAnexosSuministroEnergia(ctx context.Context, config ports.Config, opaqueReq models.RecepcionAnexosSuministroEnergiaComputarizada) (*soap.EnvelopeResponse[facturacion.RecepcionAnexosSuministroEnergiaResponse], error) {
...
func (s *siatComputarizadaService) RecepcionMasivaFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionMasivaFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.RecepcionMasivaFacturaResponse], error) {
...
// ValidacionRecepcionMasivaFactura envia una solicitud al SIAT para validar la recepción de un paquete de invoices.
func (s *siatComputarizadaService) ValidacionRecepcionMasivaFactura(ctx context.Context, config ports.Config, opaqueReq models.ValidacionRecepcionMasivaFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionMasivaFacturaResponse], error) {
...
// ValidacionRecepcionPaqueteFactura envia una solicitud al SIAT para validar la recepción de un paquete de invoices.
func (s *siatComputarizadaService) ValidacionRecepcionPaqueteFactura(ctx context.Context, config ports.Config, opaqueReq models.ValidacionRecepcionPaqueteFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionPaqueteFacturaResponse], error) {
...
func (s *siatComputarizadaService) VerificacionEstadoFactura(ctx context.Context, config ports.Config, opaqueReq models.VerificacionEstadoFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.VerificacionEstadoFacturaResponse], error) {
...
func (s *siatComputarizadaService) ReversionAnulacionFactura(ctx context.Context, config ports.Config, opaqueReq models.ReversionAnulacionFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.ReversionAnulacionFacturaResponse], error) {
...
func (s *siatComputarizadaService) AnulacionFactura(ctx context.Context, config ports.Config, opaqueReq models.AnulacionFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.AnulacionFacturaResponse], error) {
...
func (s *siatComputarizadaService) RecepcionFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.RecepcionFacturaResponse], error) {
...
func (s *siatComputarizadaService) VerificarComunicacion(ctx context.Context, config ports.Config, opaqueReq models.VerificarComunicacionComputarizada) (*soap.EnvelopeResponse[facturacion.VerificarComunicacionResponse], error) {
...
func (s *siatComputarizadaService) RecepcionPaqueteFactura(ctx context.Context, config ports.Config, opaqueReq models.RecepcionPaqueteFacturaComputarizada) (*soap.EnvelopeResponse[facturacion.RecepcionPaqueteFacturaResponse], error) {
...
var _ ports.SiatComputarizadaService = (*siatComputarizadaService)(nil)
