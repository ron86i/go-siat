...
func (s *SiatElectronicaService) AnulacionFactura(ctx context.Context, config port.Config, opaqueReq models.AnulacionFacturaElectronica) (*soap.EnvelopeResponse[facturacion.AnulacionFacturaResponse], error) {
...
func (s *SiatElectronicaService) RecepcionFactura(ctx context.Context, config port.Config, opaqueReq models.RecepcionFacturaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionFacturaResponse], error) {
...
func (s *SiatElectronicaService) ReversionAnulacionFactura(ctx context.Context, config port.Config, opaqueReq models.ReversionAnulacionFacturaElectronica) (*soap.EnvelopeResponse[facturacion.ReversionAnulacionFacturaResponse], error) {
...
func (s *SiatElectronicaService) RecepcionPaqueteFactura(ctx context.Context, config port.Config, opaqueReq models.RecepcionPaqueteFacturaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionPaqueteFacturaResponse], error) {
...
func (s *SiatElectronicaService) ValidacionRecepcionPaqueteFactura(ctx context.Context, config port.Config, opaqueReq models.ValidacionRecepcionPaqueteFacturaElectronica) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionPaqueteFacturaResponse], error) {
...
func (s *SiatElectronicaService) VerificarComunicacion(ctx context.Context, config port.Config, opaqueReq models.VerificarComunicacionElectronica) (*soap.EnvelopeResponse[facturacion.VerificarComunicacionResponse], error) {
...
func (s *SiatElectronicaService) RecepcionMasivaFactura(ctx context.Context, config port.Config, opaqueReq models.RecepcionMasivaFacturaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionMasivaFacturaResponse], error) {
...
func (s *SiatElectronicaService) ValidacionRecepcionMasivaFactura(ctx context.Context, config port.Config, opaqueReq models.ValidacionRecepcionMasivaFacturaElectronica) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionMasivaFacturaResponse], error) {
...
func (s *SiatElectronicaService) VerificacionEstadoFactura(ctx context.Context, config port.Config, opaqueReq models.VerificacionEstadoFacturaElectronica) (*soap.EnvelopeResponse[facturacion.VerificacionEstadoFacturaResponse], error) {
...
func (s *SiatElectronicaService) RecepcionAnexosSuministroEnergia(ctx context.Context, config port.Config, opaqueReq models.RecepcionAnexosSuministroEnergiaElectronica) (*soap.EnvelopeResponse[facturacion.RecepcionAnexosSuministroEnergiaResponse], error) {
