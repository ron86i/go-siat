...
type SiatCompraVentaService interface {
	...
	AnulacionFactura(ctx context.Context, config config.Config, opaqueReq models.AnulacionFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.AnulacionFacturaResponse], error)
	...
	ReversionAnulacionFactura(ctx context.Context, config config.Config, opaqueReq models.ReversionAnulacionFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.ReversionAnulacionFacturaResponse], error)
	...
	RecepcionPaqueteFactura(ctx context.Context, config config.Config, opaqueReq models.RecepcionPaqueteFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.RecepcionPaqueteFacturaResponse], error)

	// ValidacionRecepcionPaqueteFactura permite validar la recepción de paquetes de facturas.
	ValidacionRecepcionPaqueteFactura(ctx context.Context, config config.Config, opaqueReq models.ValidacionRecepcionPaqueteFacturaCompraVenta) (*soap.EnvelopeResponse[facturacion.ValidacionRecepcionPaqueteFacturaResponse], error)
