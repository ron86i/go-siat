...
// FacturaSeguridadAlimentaria representa la estructura completa de una factura de Seguridad Alimentaria para el SIAT.
type FacturaSeguridadAlimentaria struct {
	XMLName           xml.Name                      `json:"-"`
	XmlnsXsi          string                        `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                        `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraSeguridadAlimentaria  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleSeguridadAlimentaria `xml:"detalle" json:"detalle"`
}

// CabeceraSeguridadAlimentaria contiene la información general y del cliente de la factura.
type CabeceraSeguridadAlimentaria struct {
...
// DetalleSeguridadAlimentaria representa un ítem de producto alimentario.
type DetalleSeguridadAlimentaria struct {
