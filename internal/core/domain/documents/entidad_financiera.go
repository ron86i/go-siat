...
// CabeceraEntidadFinanciera contiene la información general del sector entidades financieras.
type CabeceraEntidadFinanciera struct {
	...
	MontoTotalArrendamientoFinanciero datatype.Nilable[float64] `xml:"montoTotalArrendamientoFinanciero" json:"montoTotalArrendamientoFinanciero"`
...
// DetalleEntidadFinanciera representa un ítem o producto dentro de la factura de Entidad Financiera.
type DetalleEntidadFinanciera struct {
