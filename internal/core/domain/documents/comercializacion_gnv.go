...
// FacturaComercializacionGnv representa la estructura completa de una factura de Comercialización de GNV para el SIAT.
type FacturaComercializacionGnv struct {
	XMLName           xml.Name                     `json:"-"`
	XmlnsXsi          string                       `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                       `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraComercializacionGnv  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleComercializacionGnv `xml:"detalle" json:"detalle"`
}

// CabeceraComercializacionGnv contiene la información general y del vehículo de la factura de GNV.
type CabeceraComercializacionGnv struct {
	...
	MontoVale                    datatype.Nilable[float64] `xml:"montoVale" json:"montoVale"`
...
// DetalleComercializacionGnv representa un ítem o producto dentro de la factura de GNV.
type DetalleComercializacionGnv struct {
