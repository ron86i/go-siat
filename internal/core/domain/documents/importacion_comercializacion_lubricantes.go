...
// FacturaImportacionComercializacionLubricantes representa la estructura de una factura del Sector 44
// (Importación y Comercialización de Lubricantes).
type FacturaImportacionComercializacionLubricantes struct {
	XMLName           xml.Name                                        `json:"-"`
	XmlnsXsi          string                                          `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                                          `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraImportacionComercializacionLubricantes  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleImportacionComercializacionLubricantes `xml:"detalle" json:"detalle"`
}

// CabeceraImportacionComercializacionLubricantes contiene la información general y específica para Sector 44.
type CabeceraImportacionComercializacionLubricantes struct {
...
// DetalleImportacionComercializacionLubricantes representa un ítem de detalle para Sector 44.
type DetalleImportacionComercializacionLubricantes struct {
