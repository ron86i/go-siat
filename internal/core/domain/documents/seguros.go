...
// FacturaSeguros representa la estructura completa de una factura de Seguros para el SIAT.
type FacturaSeguros struct {
	XMLName           xml.Name         `json:"-"`
	XmlnsXsi          string           `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string           `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraSeguros  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleSeguros `xml:"detalle" json:"detalle"`
}

// CabeceraSeguros contiene la información general y del cliente de la factura de Seguros.
type CabeceraSeguros struct {
	...
	AjusteAfectacionIva          float64                   `xml:"ajusteAfectacionIva" json:"ajusteAfectacionIva"`
...
// DetalleSeguros representa un ítem o servicio dentro de la factura de Seguros.
type DetalleSeguros struct {
