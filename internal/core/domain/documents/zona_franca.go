...
// FacturaZonaFranca representa la estructura completa de una factura Zona Franca para el SIAT.
type FacturaZonaFranca struct {
	XMLName           xml.Name            `json:"-"`
	XmlnsXsi          string              `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string              `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraZonaFranca  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleZonaFranca `xml:"detalle" json:"detalle"`
}

// CabeceraZonaFranca contiene la información general y del cliente de la factura Zona Franca.
type CabeceraZonaFranca struct {
	...
	NumeroParteRecepcion         datatype.Nilable[string]  `xml:"numeroParteRecepcion" json:"numeroParteRecepcion"`
...
// DetalleZonaFranca representa un ítem o producto dentro de la factura Zona Franca.
type DetalleZonaFranca struct {
