...
// FacturaComercializacionGnGlp representa la estructura completa de una factura de Comercialización de GN y GLP para el SIAT.
type FacturaComercializacionGnGlp struct {
	XMLName           xml.Name                       `json:"-"`
	XmlnsXsi          string                         `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                         `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraComercializacionGnGlp  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleComercializacionGnGlp `xml:"detalle" json:"detalle"`
}

// CabeceraComercializacionGnGlp contiene la información general y del cliente de la factura.
type CabeceraComercializacionGnGlp struct {
...
// DetalleComercializacionGnGlp representa un ítem o producto dentro de la factura.
type DetalleComercializacionGnGlp struct {
