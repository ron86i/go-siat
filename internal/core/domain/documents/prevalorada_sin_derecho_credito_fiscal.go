...
// FacturaPrevaloradaSinDerechoCreditoFiscal representa la solicitud para el Sector 36.
type FacturaPrevaloradaSinDerechoCreditoFiscal struct {
	...
	Cabecera          CabeceraPrevaloradaSinDerechoCreditoFiscal `xml:"cabecera" json:"cabecera"`
	Detalle           DetallePrevaloradaSinDerechoCreditoFiscal  `xml:"detalle" json:"detalle"`
}

// CabeceraPrevaloradaSinDerechoCreditoFiscal contiene los datos generales de la factura.
type CabeceraPrevaloradaSinDerechoCreditoFiscal struct {
...
// DetallePrevaloradaSinDerechoCreditoFiscal representa un ítem de la factura.
type DetallePrevaloradaSinDerechoCreditoFiscal struct {
