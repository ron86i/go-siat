...
// CabeceraTelecomunicaciones contiene la información general del sector telecomunicaciones.
type CabeceraTelecomunicaciones struct {
...
// DetalleTelecomunicaciones representa un ítem o producto dentro de la factura de Telecomunicaciones.
type DetalleTelecomunicaciones struct {
