...
// FacturaMonedaExtranjera representa la estructura de una factura del Sector 9
// (Venta de Moneda Extranjera).
type FacturaMonedaExtranjera struct {
	XMLName           xml.Name                  `json:"-"`
	XmlnsXsi          string                    `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                    `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraMonedaExtranjera  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleMonedaExtranjera `xml:"detalle" json:"detalle"`
}

// CabeceraMonedaExtranjera contiene la información general y específica para Sector 9.
type CabeceraMonedaExtranjera struct {
	...
	CodigoTipoOperacion          int                       `xml:"codigoTipoOperacion" json:"codigoTipoOperacion"`
	...
	IngresoDiferenciaCambio      float64                   `xml:"ingresoDiferenciaCambio" json:"ingresoDiferenciaCambio"`
	...
	TipoCambioOficial            float64                   `xml:"tipoCambioOficial" json:"tipoCambioOficial"`
	CodigoDocumentoSector        int                       `xml:"codigoDocumentoSector" json:"codigoDocumentoSector"`
}

// DetalleMonedaExtranjera representa un ítem de detalle para Sector 9.
type DetalleMonedaExtranjera struct {
