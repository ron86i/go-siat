...
// FacturaJuegoAzar representa la estructura completa de una factura de Juego de Azar para el SIAT.
type FacturaJuegoAzar struct {
	XMLName           xml.Name           `json:"-"`
	XmlnsXsi          string             `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string             `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraJuegoAzar  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleJuegoAzar `xml:"detalle" json:"detalle"`
}

// CabeceraJuegoAzar contiene la información general y del cliente de la factura de Juego de Azar.
type CabeceraJuegoAzar struct {
	...
	MontoTotalIj                 float64                   `xml:"montoTotalIj" json:"montoTotalIj"`
	MontoTotalSujetoIpj          float64                   `xml:"montoTotalSujetoIpj" json:"montoTotalSujetoIpj"`
...
// DetalleJuegoAzar representa un ítem o producto dentro de la factura.
type DetalleJuegoAzar struct {
