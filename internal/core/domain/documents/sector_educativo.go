...
// FacturaSectorEducativo representa la estructura completa de una factura del Sector Educativo para el SIAT.
type FacturaSectorEducativo struct {
	XMLName           xml.Name                 `json:"-"`
	XmlnsXsi          string                   `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                   `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraSectorEducativo  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleSectorEducativo `xml:"detalle" json:"detalle"`
}

// CabeceraSectorEducativo contiene la información general y del cliente de la factura del Sector Educativo.
type CabeceraSectorEducativo struct {
...
// DetalleSectorEducativo representa un ítem o servicio dentro de la factura del Sector Educativo.
type DetalleSectorEducativo struct {
