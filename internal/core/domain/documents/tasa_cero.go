...
// FacturaTasaCero representa la estructura completa de una factura Tasa Cero para el SIAT.
type FacturaTasaCero struct {
	XMLName           xml.Name          `json:"-"`
	XmlnsXsi          string            `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string            `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraTasaCero  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleTasaCero `xml:"detalle" json:"detalle"`
}

// CabeceraTasaCero contiene la información general y del cliente de la factura Tasa Cero.
type CabeceraTasaCero struct {
...
// DetalleTasaCero representa un ítem o servicio dentro de la factura Tasa Cero.
type DetalleTasaCero struct {
