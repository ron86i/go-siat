...
// FacturaSectorEducativoZF representa la estructura completa de una factura del Sector Educativo Zona Franca para el SIAT.
type FacturaSectorEducativoZF struct {
	XMLName           xml.Name                   `json:"-"`
	XmlnsXsi          string                     `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                     `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraSectorEducativoZF  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleSectorEducativoZF `xml:"detalle" json:"detalle"`
}

// CabeceraSectorEducativoZF contiene la información general y del cliente de la factura del Sector Educativo Zona Franca.
type CabeceraSectorEducativoZF struct {
	...
	NombreEstudiante             string                    `xml:"nombreEstudiante" json:"nombreEstudiante"`
...
// DetalleSectorEducativoZF representa un ítem o servicio dentro de la factura del Sector Educativo Zona Franca.
type DetalleSectorEducativoZF struct {
