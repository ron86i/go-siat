...
// FacturaComercializacionHidro representa la estructura completa de una factura de Comercialización de Hidrocarburos para el SIAT.
type FacturaComercializacionHidro struct {
	XMLName           xml.Name                       `json:"-"`
	XmlnsXsi          string                         `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                         `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraComercializacionHidro  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleComercializacionHidro `xml:"detalle" json:"detalle"`
}

// CabeceraComercializacionHidro contiene la información general y del cliente de la factura de Comercialización de Hidrocarburos.
type CabeceraComercializacionHidro struct {
...
// DetalleComercializacionHidro representa un ítem o servicio dentro de la factura de Comercialización de Hidrocarburos.
type DetalleComercializacionHidro struct {
