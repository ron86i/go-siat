...
// FacturaBiodiesel representa la estructura completa de una factura de Biodiesel para el SIAT.
type FacturaBiodiesel struct {
	XMLName           xml.Name             `json:"-"`
	XmlnsXsi          string               `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string               `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraBiodiesel    `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleBiodiesel   `xml:"detalle" json:"detalle"`
}

// CabeceraBiodiesel contiene la información general y del cliente de la factura.
type CabeceraBiodiesel struct {
...
// DetalleBiodiesel representa un ítem o producto dentro de la factura.
type DetalleBiodiesel struct {
