...
// FacturaHospitalClinicaZF representa la estructura completa de una factura de Hospital/Clínica Zona Franca para el SIAT.
type FacturaHospitalClinicaZF struct {
	XMLName           xml.Name                   `json:"-"`
	XmlnsXsi          string                     `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                     `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraHospitalClinicaZF  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleHospitalClinicaZF `xml:"detalle" json:"detalle"`
}

// CabeceraHospitalClinicaZF contiene la información general y del cliente de la factura.
type CabeceraHospitalClinicaZF struct {
...
// DetalleHospitalClinicaZF representa un ítem o producto dentro de la factura.
type DetalleHospitalClinicaZF struct {
