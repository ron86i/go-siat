...
// FacturaAlquilerZF representa la estructura completa de una factura de Alquiler en Zona Franca para el SIAT.
type FacturaAlquilerZF struct {
	XMLName           xml.Name            `json:"-"`
	XmlnsXsi          string              `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string              `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraAlquilerZF  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleAlquilerZF `xml:"detalle" json:"detalle"`
}

// CabeceraAlquilerZF contiene la información general y del cliente de la factura de Alquiler ZF.
type CabeceraAlquilerZF struct {
...
// DetalleAlquilerZF representa un ítem o servicio dentro de la factura de Alquiler ZF.
type DetalleAlquilerZF struct {
