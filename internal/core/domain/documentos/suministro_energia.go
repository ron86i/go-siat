...
// FacturaSuministroEnergia representa la estructura completa de una factura de Suministro de Energía para el SIAT.
type FacturaSuministroEnergia struct {
	XMLName           xml.Name                   `json:"-"`
	XmlnsXsi          string                     `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                     `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraSuministroEnergia  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleSuministroEnergia `xml:"detalle" json:"detalle"`
}

// CabeceraSuministroEnergia contiene la información general del suministro de energía.
type CabeceraSuministroEnergia struct {
...
// DetalleSuministroEnergia representa un ítem o producto dentro de la factura de Energía.
type DetalleSuministroEnergia struct {
