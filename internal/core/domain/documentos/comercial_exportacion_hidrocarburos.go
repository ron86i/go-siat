...
// FacturaComercialExportacionHidro representa la estructura completa de una factura de Comercial Exportación Hidrocarburos para el SIAT.
type FacturaComercialExportacionHidro struct {
	XMLName           xml.Name                           `json:"-"`
	XmlnsXsi          string                             `xml:"xmlns:xsi,attr" json:"-"`
	XsiSchemaLocation string                             `xml:"xsi:noNamespaceSchemaLocation,attr" json:"-"`
	Cabecera          CabeceraComercialExportacionHidro  `xml:"cabecera" json:"cabecera"`
	Detalle           []DetalleComercialExportacionHidro `xml:"detalle" json:"detalle"`
}

// CabeceraComercialExportacionHidro contiene la información general y del cliente de la factura de Comercial Exportación Hidrocarburos.
type CabeceraComercialExportacionHidro struct {
...
// DetalleComercialExportacionHidro representa un ítem o servicio dentro de la factura de Comercial Exportación Hidrocarburos.
type DetalleComercialExportacionHidro struct {
